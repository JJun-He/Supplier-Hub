...
> 후속 상태(2026-09-16): 8-A에서 C-01~04, E-01/E-03/E-06, B 실패 매핑과 오류 표 회귀 검증을 반영했다. [설계 §16](architecture-decisions.md#16-8-a-입력중복예외-계약-보완)과 [구현 진행표](implementation-plan.md#64-8단계-진행-상태)를 참고한다. 아래 분석은 감사 기준 커밋 당시 기록이며, 8-B 자원 제한·관측성은 [설계 §17](architecture-decisions.md#17-8-b-자원-제한과-업무-지표)에서 완료 상태를 확인한다. 8-C/8-D는 아직 남아 있다.
